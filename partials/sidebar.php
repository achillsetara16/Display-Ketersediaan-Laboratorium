...
<div class="sidebar">
  ...
  <ul class="nav-links">
    ...
    <?php elseif ($role === 'superadmin'): ?>
      ...
      <li><a href="../Super_Admin/list_matkul.php" class="<?= $current == 'list_matkul.php' ? 'active' : '' ?>"><i class="bi bi-journal-text"></i>Courses List</a></li>
      <li><a href="../Super_Admin/users_list.php" class="<?= $current == 'users_list.php' ? 'active' : '' ?>"><i class="bi bi-people-fill"></i>Users List</a></li>
      <li><a href="../Super_Admin/loan_data.php" class="<?= $current == 'loan_data.php' ? 'active' : '' ?>"><i class="bi bi-calendar-check"></i>Loan Data</a></li>
    <?php else: ?>
