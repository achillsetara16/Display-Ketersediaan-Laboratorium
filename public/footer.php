    ...
    <div class="w-full px-6 py-10 grid md:grid-cols-2 gap-15">
      ...
      <div class="space-y-10">
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 flex-shrink-0 text-white" fill="none"
        ...
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3 text-white" viewBox="0 0 20 20"
            fill="currentColor">
            <path
              d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016.615 4H3.385a2 2 0 00-1.382 1.884zM18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
          </svg>
          <div>
            <p class="font-semibold text-gray-200">Email:</p>
            <a href="mailto:info@polibatam.ac.id"
              class="hover:underline hover:text-gray-100 transition">info@polibatam.ac.id</a><br>
            <a href="mailto:helpdesk1074@polibatam.ac.id"
              class="hover:underline hover:text-gray-100 transition">helpdesk1074@polibatam.ac.id</a>
          </div>
        </div>
        ...
        <div class="flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 mr-3 flex-shrink-0 text-white" fill="none"
            viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
              d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.357 4.072a1 1 0 01-.21.95l-2.198 2.198a11.042 11.042 0 005.586 5.586l2.198-2.198a1 1 0 01.95-.21l4.072 1.357a1 1 0 01.684.948V19a2 2 0 01-2 2h-1c-9.941 0-18-8.059-18-18V5z" />
          </svg>
          <div>
